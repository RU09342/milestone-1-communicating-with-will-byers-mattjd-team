...
volatile unsigned int num_of_bytes;          // Takes on the Value of Received Byte Zero (when byte_count = 0),                                                // Stores Total Number of Bytes to be Received
...
void TimerB0Setup()
{
    ...
    TB0CCTL4 |= OUTMOD_7;                    // Reset/Set Mode
